...
add_theme_support('post-thumbnails'); //Ativa suporte de thumbnails no painel.
set_post_thumbnail_size(120, 120);//Ativa o tamanho padrão do thumbnail de 120x120;


/////////CHAMAR SCRIPTS JS E CSS.
